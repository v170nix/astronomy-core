...
fun getSimonJ2000KeplerElements(id: KeplerElementsObject): KeplerElements = when (id) {
...
private class SimonJ2000KeplerElements(override val a: DoubleArray,
