...
class EquinoxesSolsticesTest {
    ...
    fun findEquinoxSolsticeTest() = runTest {
        ...
        assertEquals("2022-03-20T15:33", result[0].date.toString().substring(0..15))
        assertEquals("2022-06-21T09:13", result[1].date.toString().substring(0..15))
        assertEquals("2022-09-23T01:03", result[2].date.toString().substring(0..15))
        assertEquals("2022-12-21T21:48", result[3].date.toString().substring(0..15))
    }
}