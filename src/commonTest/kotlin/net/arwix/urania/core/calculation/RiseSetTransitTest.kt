...
//import net.arwix.urania.core.observer.topocentricTransformation
...
//    }
    ...
    fun obtainCertainRiseSetTransitMurmansk() {
        ...
        println("mjd ${instant.toMJD(false)}")
...
//                    latitude = (68.0 + 58.0 / 60.0 + 23.9 / 60.0 / 60.0).deg.toRad(),
            ...
            val vector = SphericalVector(
                phi = ((3.0 + 57.0 / 60.0 + 12.13 / 60.0 / 60.0) * 15.0).deg.toRad(),
                theta = (20.0 + 26.0 / 60.0 + 28.8 / 60.0 / 60.0).deg.toRad(),
                r = 1.01243067647025
            )
//
//            topocentricTransformation(
//                instant,
//                vector,
//                observer.position
//            )
